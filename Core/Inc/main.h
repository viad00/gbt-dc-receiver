...
/* Private defines -----------------------------------------------------------*/
#define BTN_SHARP_Pin GPIO_PIN_6
#define BTN_SHARP_GPIO_Port GPIOC
#define BTN_SHARP_EXTI_IRQn EXTI9_5_IRQn
#define BTN_STAR_Pin GPIO_PIN_7
#define BTN_STAR_GPIO_Port GPIOC
#define BTN_STAR_EXTI_IRQn EXTI9_5_IRQn
